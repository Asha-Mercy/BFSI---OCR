The goal of this project is to develop a robust system that uses Optical Character Recognition (OCR) for efficiently extracting and analyzing data from bank statements in various formats.
